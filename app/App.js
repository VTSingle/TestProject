                        ...
                        <Modal key="root" duration={0}>
                            ...
                            >
                                <Scene icon={iconList} initial>
                                    <Scene hideNavBar={true} key="MyInfo" component={MyInfo} panHandlers={null}
                                           type={typeRout}/>
                                    <Scene hideNavBar={true} key="EditItem" component={EditItem} panHandlers={null}
                                           type={typeRout}/>
                                </Scene>
                                <Scene icon={iconAdd}>
                                    <Scene hideNavBar={true} key="AddInfo" component={AddInfo} panHandlers={null}
                                           type={typeRout}/>
                                </Scene>
                            </Scene>
                        </Modal>
